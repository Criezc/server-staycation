...
module.exports = {
  ...
  addItem: async (req, res) => {
    try {
      ...
      if (req.files.length > 0) {
        ...
        req.flash("alertMessage", "Success Adding Item!");
        req.flash("alertStatus", "success");
        res.redirect("/admin/item");
      }
    } catch (error) {
  ...
  editItem: async (req, res) => {
    try {
      ...
      if (req.files.length > 0) {
        ...
        await item.save();
        req.flash("alertMessage", "Success Updating Item!");
        req.flash("alertStatus", "success");
        res.redirect("/admin/item");
      } else {
        item.title = title;
  ...
  deleteItem: async (req, res) => {
    try {
      ...
      await item.remove();
      req.flash("alertMessage", "Success Deleting Item!");
      req.flash("alertStatus", "success");
      res.redirect("/admin/item");
    } catch (error) {
      req.flash("alertMessage", `${error.message}`);
  ...
  editFeature: async (req, res) => {
    const { itemId, name, qty, id } = req.body;
    try {
  ...
  editActivity: async (req, res) => {
    const { itemId, name, type, id } = req.body;
    try {
  ...
  actionConfirmation: async (req, res) => {
    ...
    try {
      ...
      await booking.save();
      req.flash("alertMessage", "Konfirmasi Pembayaran Berhasil!");
      req.flash("alertStatus", "success");
  ...
  actionRejection: async (req, res) => {
    ...
    try {
      ...
      await booking.save();
      req.flash("alertMessage", "Reject Pembayaran Berhasil!");
      req.flash("alertStatus", "success");
      res.redirect(`/admin/booking/${id}`);
    } catch (error) {
      res.redirect(`/admin/booking/${id}`);
